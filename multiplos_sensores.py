...
import os
import sys
from image_processing import image_processing2, get_mask
...
class SensorManager:
    ...
    def save_rgb_image_color(self, image):
       ...
       # Envia frame para a variável global
        global video_frames
        video_frames = array
...
def run_simulation(args, client):
    ...
    try:
        ...
        print(ponto_spawn)
        # Location(x=-511.729248, y=240.136826, z=0.015060)
        #vehicle = world.spawn_actor(bp, carla.Transform(carla.Location(x=-105.499306, y=9.305541, z=9.771310), carla.Rotation(pitch=-1.156556, yaw=-179.923187, roll=0.000000)))
        #vehicle = world.spawn_actor(bp, carla.Transform(carla.Location(x=402.525452, y=-124.737938, z=0.281942), carla.Rotation(pitch=0.000000, yaw=-89.401421, roll=0.000000)))
        ...
        vehicle.enable_constant_velocity(carla.Vector3D(3, 0, 0))

        #vehicle.VehicleControl.steer = 200
